...
### 2. R 스파크 클러스터 설치 [^sparklyr-windows-install]
...
<img src="fig/spark-ds-setup.png" alt="스파크 클러스터 설치" width="77%" />
...
예를 들어, 윈도우 환경에서 하둡을 돌리기 위해서는 [Hadoop winutils](https://github.com/steveloughran/winutils), 즉 
