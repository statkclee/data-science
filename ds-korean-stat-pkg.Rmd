...
1.  웹에서 하는 ggplot2: cardiomoon.shinyapps.io/ggplot2new

2.  웹에서 하는 R 통계 4.0 무료버젼 :

    -   cardiomoon.shinyapps.io/reg1
    -   cardiomoon.shinyapps.io/reg2
    -   cardiomoon.shinyapps.io/reg3

3.  propensity score matching: cardiomoon.shinyapps.io/psmatching

4.  강의용 앱 : p값, 카이제곱분포, t분포: cardiomoon.shinyapps.io/ttest

5.  강의용앱 : 다중검정의 문제: cardiomoon.shinyapps.io/multiplicity

6.  샘플수의 계산: cardiomoon.shinyapps.io/sampleSize
