...
``` {r presid-tmap-ballots, message=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
# 4. 주제도 시각화(tmap)-------------------------------------------
## 4.1. 전체 -------------------------------
...
``` {r presid-tmap-ballots-facet, message=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
## 4.2. Facet -------------------------------
pal10 <- viridis(10, option="D")
# tmap_mode("plot")
...
``` {r presid-tmap-side-by-side, message=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
## 4.3. 박근혜 vs 문재인 -------------------------------
## 박근혜 문재인 투표 나란히 비교
# tmap_mode("plot")
...
``` {r presid-tmap-interactive, message=FALSE, warning=FALSE, message=FALSE, eval=FALSE}
## 4.3. 표차이 분석 : 박근혜 - 문재인 -------------------------------
