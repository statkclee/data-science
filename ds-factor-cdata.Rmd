...
![요인 수준/범주별로 라벨 변경](fig/factor-label.png){#id .class width="57%"}
...
![요인 수준/범주별 순서 변경](fig/factor-relevel.png){#id .class width="57%"}
...
![요인 수준/범주 줄이기](fig/factor-ifelse.png){#id .class width="57%"}
...
## 연속형 변수를 범주화 {#forcats-bins}

![연속형 변수를 범주화](fig/factor-casewhen.png){#id .class width="57%"}
...
# 캐글 설문 데이터셋 {#ds-factor-forcats-kaggle}
