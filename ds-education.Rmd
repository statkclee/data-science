...
## 데이터 과학 기업 활용방안 {#enterprise-data-science}
...
- [삼정KPMG 경제연구원 (2020-03-06), "기업 운영 혁신을 위한 데이터 과학: 기업의 활용 방안"](https://home.kpmg/kr/ko/home/insights/2020/03/issue-monitor-121.html)
    - [PDF 다운로드](https://assets.kpmg/content/dam/kpmg/kr/pdf/2020/kr-im-data-20200306.pdf)
...
- 데이터 과학 입문 &larr; **데이터 과학 논문 제작**
    - [데이터 과학 입문(2019): 봄학기](https://statkclee.github.io/yonsei/)
    - [데이터 과학 입문(2020): 봄학기](https://statkclee.github.io/ds-intro-2020/) &larr; 대폭 보강 예정 ^^
- 데이터 과학을 위한 소프트웨어 공학(Software Engineering for Data Science) &larr; **데이터 과학 제품 제작**
    - [Software Engineering for Data Science (2019): 가을학기](https://statkclee.github.io/yonsei2/)
