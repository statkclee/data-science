...
<img src="fig/data-science-workflow.png" alt="데이터 사이언스 작업흐름" width="100%" />
...
1. 기계학습 데이터 과학자 (Machine Learning Data Scientist): 기계학습 모형 개발, R/파이썬
...
<img src="fig/ds-team-isolated.png" alt="격리 구조를 갖는 팀구조" width="100%" />

다른 대안으로 데이터 엔지니어, 데이터 과학자, 기획자가 각각 팀을 이뤄 다양한 데이터 제품과 서비스를 기획하는 것도 가능한 형태다.

<img src="fig/ds-team-embedded.png" alt="임베디드된 구조를 갖는 팀구조" width="100%" />
...
<img src="fig/ds-matrix-organization.png" alt="임베디드된 구조를 갖는 팀구조" width="100%" />
