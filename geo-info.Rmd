...
``` {r geo-info-rworldmap, message=FALSE, warning=FALSE, comment=FALSE}
...
``` {r geo-info-ggmap-index, message=FALSE, warning=FALSE, comment=FALSE}
library(ggmap)
# 위치를 지정한다.
...
``` {r geo-info-get-map-ggmap, message=FALSE, warning=FALSE, comment=FALSE, eval=FALSE}
