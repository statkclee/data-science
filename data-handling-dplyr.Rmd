...
## Wide 형식 &rarr; Long 형식 데이터 [^tidyexplain] {#dplyr-from-wide-to-long}
...
``` {r tb-gather-animation, eval=FALSE}
...
<img src="images/tidyr-spread-gather.gif" alt="Spread-Gather 예제" width="100%" />
