...
``` {r r-lang-table-plot, message=FALSE, warning=FALSE, comment=FALSE}
# 기본 분석 스크립트
...
``` {r r-lang-cls, message=FALSE, warning=FALSE, comment=FALSE}
...
``` {r r-lang-cls-rprofile, message=FALSE, warning=FALSE, comment=FALSE, eval=FALSE}
….
local({
