...
( $2^7$ = 128). 참고: [아스키 코드 테이블](encoding-ascii.html)
...
<img src="fig/encoding-fixed-width.png" alt="고정폭 텍스트 배열" width="50%" />
...
<img src="fig/encoding-unicode.png" alt="변동폭 텍스트 배열" width="50%" />
