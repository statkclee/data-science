...
layout: page
title: xwMOOC 데이터 과학
subtitle: 아마존 알렉사 웹정보(웹API) - KBO 프로야구 웹사이트
date: 2017-08-01
author: xwMOOC
output:
  html_document: 
...
team_traffic_df <- readRDS("data/team_traffic_df.rds")
