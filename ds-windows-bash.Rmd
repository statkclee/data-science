...
## 배쉬쉘 빠져나오기 [^exit-bash] {#windows-wsl-activate-command-bash-exit} 

[^exit-bash]: [A Guide to Invoking WSL](https://devblogs.microsoft.com/commandline/a-guide-to-invoking-wsl/)

`exit` 명령어로 WSL 배쉬쉘에서 빠져나와 다시 파워쉘 혹은 도스쉘로 빠져나온다.

![WSL 빠져나오기](fig/windows-wsl-exit.gif){#id .class width="100%"}
